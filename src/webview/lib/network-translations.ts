...
export const NET_LABELS = {
  ...
  latestPlanets: {
    ko: "최근 갱신된 행성",
    en: "Recently Updated Planets",
    ja: "最近更新された惑星",
    zh: "最近更新的行星",
  },
  latestPosts: {
    ko: "최신 관측 로그",
    en: "Latest Observation Logs",
    ja: "最新の観測ログ",
    zh: "最新观测日志",
  },
  latestSettlements: {
    ko: "최근 정산 결과",
    en: "Recent Settlements",
    ja: "最近の決算結果",
    zh: "最近结算结果",
  },
  viewAll: {
  ...
  noPlanets: {
    ko: "등록된 행성이 없습니다",
    en: "No planets registered",
    ja: "登録された惑星はありません",
    zh: "没有注册的行星",
  },
  noPosts: {
    ko: "관측 로그가 아직 없습니다",
    en: "No observation logs yet",
    ja: "観測ログはまだありません",
    zh: "暂无观测日志",
  },
  registerFirst: {
    ko: "실제 행성을 등록해보세요",
    en: "Register a planet",
    ja: "惑星を登録してみましょう",
    zh: "注册一个行星吧",
  },
