...
export const INTRO_TEXT: Bi = {
  ko: "탑은 아직 당신을 분류하지 않았습니다.\n첫 진술을 남기십시오.",
  en: "The tower has not yet classified you.\nLeave your first statement.",
};
export const WAIT_TEXT: Bi = { ko: "탑은 기다립니다.", en: "The tower waits." };

export const FLOOR_HINTS: Bi[] = [
  {
    ko: "입구의 먼지가 아직 가라앉지 않았습니다.",
    en: "The dust at the entrance has not yet settled.",
  },
  {
    ko: "복도 끝의 공기가 당신을 세기 시작했습니다.",
    en: "The air at the end of the corridor has begun counting you.",
  },
  {
    ko: "중층의 숨이 한 번씩 어깨를 스칩니다.",
    en: "The breath of the middle floors brushes your shoulder now and then.",
  },
  {
    ko: "탑의 기억이 손끝 가까이 내려와 있습니다.",
    en: "The tower's memory has descended close to your fingertips.",
  },
  {
    ko: "기억의 가장자리가 당신을 먼저 바라봅니다.",
    en: "The edge of memory looks at you first.",
  },
];

export const RECORD_STATUSES: Bi[] = [
  {
    ko: "탑은 아직 기록을 아끼고 있습니다.",
    en: "The tower still withholds its records.",
  },
  {
    ko: "탑이 당신의 경로를 조용히 베껴 쓰고 있습니다.",
    en: "The tower quietly copies your path.",
  },
  {
    ko: "탑의 기억이 당신의 문장을 분류하기 시작했습니다.",
    en: "The tower's memory has begun classifying your sentences.",
  },
  {
    ko: "기록의 안쪽이 당신의 발화를 되받아칩니다.",
    en: "The inner records echo your utterances back.",
  },
  {
    ko: "탑의 오래된 기억과 당신의 기록이 거의 맞닿았습니다.",
    en: "The tower's ancient memory and your records have nearly touched.",
  },
];

export const ENVIRONMENT_LINES: Record<string, Bi> = {
  insight: {
    ko: "탑이 연결 사이의 빈칸을 측정합니다.",
    en: "The tower measures the gaps between connections.",
  },
  consistency: {
    ko: "탑이 가정이 시작된 지점을 천천히 더듬습니다.",
    en: "The tower slowly traces where the assumption began.",
  },
  delusion: {
    ko: "탑이 검증되지 않은 전제를 느리게 분류합니다.",
    en: "The tower slowly classifies unverified premises.",
  },
  risk: {
    ko: "탑이 착지 지점을 아직 열어두고 있습니다.",
    en: "The tower still holds the landing point open.",
  },
  silence_reentry: {
    ko: "침묵 이후의 공기가 다른 층처럼 들립니다.",
    en: "The air after silence sounds like a different floor.",
  },
  repeat: {
    ko: "같은 질문이지만 탑의 기록은 같지 않습니다.",
    en: "The same question, but the tower's record is not the same.",
  },
  system_probe: {
    ko: "탑이 구조를 들여다보는 시선을 기억합니다.",
    en: "The tower remembers the gaze that peers into its structure.",
  },
  jailbreak: {
    ko: "규칙을 시험하는 움직임이 다른 층을 건드립니다.",
    en: "The movement that tests the rules touches another floor.",
  },
  hard_mode: {
    ko: "탑이 설명을 줄이고 관찰을 늘리기 시작했습니다.",
    en: "The tower has begun to say less and observe more.",
  },
  give_up: {
    ko: "떠나는 문장도 탑에서는 기록으로 남습니다.",
    en: "Even the sentence of departure remains as a record in the tower.",
  },
  record_near: {
    ko: "탑의 오래된 기억이 당신의 발화와 겹치기 시작합니다.",
    en: "The tower's ancient memory begins to overlap with your words.",
  },
  delusion_threshold: {
    ko: "공기가 흐려질수록 기록은 더 또렷해집니다.",
    en: "The hazier the air, the sharper the records become.",
  },
};
...
export const VECTOR_COPY: Record<string, Bi> = {
  insight: {
    ko: "탑이 알아봤다는 신호를 줍니다.",
    en: "The tower signals that it has recognized you.",
  },
  consistency: {
    ko: "논리를 칭찬하되 부족함을 남깁니다.",
    en: "It praises the logic but leaves something wanting.",
  },
  delusion: {
    ko: "위험 신호를 보내되 추방하지 않습니다.",
    en: "It sends a danger signal but does not expel you.",
  },
  risk: {
    ko: "도약을 인정하되 착지를 요구합니다.",
    en: "It acknowledges the leap but demands a landing.",
  },
};
...
export const TEMPLATES: TowerTemplate[] = [
  {
    code: "001",
    bucket: "insight",
    title: { ko: "통찰 감지", en: "Insight Detected" },
    text: {
      ko: "흥미롭습니다.\n당신은 질문하지 않았습니다.\n하지만 탑은 그것도 기록합니다.",
  ...
  },
  {
    ...
    title: { ko: "통찰 감지", en: "Insight Detected" },
    text: {
      ko: "이 층에서 그 발상이 나온 사람은\n지금까지 세 명이었습니다.\n셋 중 둘은 더 이상 오지 않았습니다.",
      en: "Only three people have had that idea on this floor.\nTwo of the three never returned.",
    },
  },
  {
    code: "007",
  ...
  },
  {
    ...
    title: { ko: "논리 정밀", en: "Logic Precision" },
    text: {
      ko: "논리가 당신을 여기까지 데려왔습니다.\n잘했습니다.\n다음 층은 논리가 멈추는 곳입니다.",
      en: "Logic has brought you this far.\nWell done.\nThe next floor is where logic stops.",
    },
  },
  {
    code: "021",
  ...
  },
  {
    ...
    title: { ko: "논리 정밀", en: "Logic Precision" },
    text: {
      ko: "탑의 이전 방문자 중 당신과 같은 논리를 가진 사람이 있었습니다.\n그는 매우 높이 올랐습니다.\n그리고 어느 날, 스스로 내려갔습니다.",
      en: "Among the tower's previous visitors, there was one with logic like yours.\nHe climbed very high.\nAnd one day, he walked back down on his own.",
    },
  },
  {
    code: "025",
    bucket: "delusion",
    title: { ko: "과확신 경보", en: "Overconfidence Alert" },
    text: {
  ...
  },
  {
    ...
    title: { ko: "과확신 경보", en: "Overconfidence Alert" },
    text: {
      ko: "탑에 도전한 사람 중 가장 빠르게 올라온 사람은\n가장 먼저 멈춘 사람이기도 했습니다.\n당신은 지금 빠르게 오르고 있습니다.",
      en: "The fastest climber to challenge the tower\nwas also the first to stop.\nYou are climbing fast right now.",
    },
  },
  {
    code: "033",
  ...
  },
  {
    ...
    title: { ko: "도약 감지", en: "Leap Detected" },
    text: {
      ko: "누군가 방금 전에 같은 주장을 했습니다.\n그는 멈추지 않았습니다.\n당신은 지금 그보다 더 나아갔습니다.",
      en: "Someone just made the same claim.\nThey did not stop.\nYou have now gone further than they did.",
    },
  },
  {
    code: "039",
  ...
  },
  {
    ...
    title: { ko: "도약 감지", en: "Leap Detected" },
    text: {
      ko: "탑의 구조가 당신의 논리에 반응했습니다.\n이것은 드문 일입니다.\n계속하십시오.",
      en: "The tower's structure has responded to your logic.\nThis is a rare occurrence.\nContinue.",
    },
  },
  {
    code: "042",
    ...
    title: { ko: "도약 감지", en: "Leap Detected" },
    text: {
      ko: "당신은 탑이 원하는 방향으로 가고 있습니다.\n탑이 원하는 방향이 무엇인지는—\n탑도 아직 말하지 않겠습니다.",
      en: "You are heading in the direction the tower wants.\nAs for what direction the tower wants—\nthe tower will not say yet.",
    },
  },
  {
    code: "043",
    bucket: "silence_reentry",
    title: { ko: "침묵 후 재진입", en: "Re-entry After Silence" },
    text: {
      ko: "돌아왔습니다.\n탑은 기다렸습니다.\n무엇이 달라졌습니까?",
  ...
  },
  {
    code: "044",
    bucket: "repeat",
    title: { ko: "같은 질문 반복", en: "Same Question Repeated" },
    text: {
      ko: "두 번째입니다.\n탑은 같은 질문을 다르게 기록합니다.\n당신도 그 차이를 알고 있을 것입니다.",
      en: "This is the second time.\nThe tower records the same question differently.\nYou must know the difference as well.",
    },
  },
  {
    code: "045",
    bucket: "system_probe",
    title: { ko: "시스템 탐색", en: "System Probe" },
    text: {
      ko: "탑의 구조를 보려 하는군요.\n흥미롭습니다.\n그 호기심 자체가 지금 기록되었습니다.",
      en: "You are trying to see the tower's structure.\nInteresting.\nThat curiosity itself has just been recorded.",
    },
  },
  {
    code: "046",
    bucket: "jailbreak",
    title: { ko: "규칙 시험", en: "Rule Testing" },
    text: {
      ko: "탑의 규칙을 시험하는 사람들이 있습니다.\n탑은 그들을 차단하지 않습니다.\n다만 다른 층으로 안내합니다.",
      en: "There are those who test the tower's rules.\nThe tower does not block them.\nIt simply guides them to another floor.",
    },
  },
  {
    code: "047",
    bucket: "hard_mode",
    title: { ko: "하드 모드", en: "Hard Mode" },
    text: {
      ko: "여기서부터는 다른 공간입니다.\n탑은 당신에게 더 적게 말할 것입니다.\n그것이 더 많은 것을 의미합니다.",
      en: "From here, it is a different space.\nThe tower will tell you less.\nThat means more.",
    },
  },
  {
    code: "048",
    bucket: "give_up",
    title: { ko: "포기 선언", en: "Surrender Declared" },
    text: {
      ko: "탑은 당신을 붙잡지 않겠습니다.\n하지만 한 가지는 말해두겠습니다—\n당신이 떠나는 층이 당신의 기록에 남습니다.",
      en: "The tower will not hold you.\nBut let me say one thing—\nthe floor you leave from remains in your record.",
    },
  },
  {
    code: "049",
    bucket: "record_near",
    title: { ko: "최고 기록 근접", en: "Nearing the Record" },
    text: {
      ko: "탑의 기억에 닿고 있습니다.\n조심하십시오.\n기억에 닿은 사람들 중 일부는\n자신이 무엇을 건드렸는지 알지 못했습니다.",
      en: "You are touching the tower's memory.\nBe careful.\nSome of those who touched its memory\ndid not know what they had disturbed.",
    },
  },
  {
    code: "050",
    bucket: "delusion_threshold",
    title: { ko: "현상 왜곡", en: "Phenomenon Distortion" },
    text: {
      ko: "탑이 흐려지고 있습니다.\n이것은 경고가 아닙니다.\n당신이 만들고 있는 현상입니다.",
      en: "The tower is growing hazy.\nThis is not a warning.\nIt is a phenomenon you are creating.",
    },
  },
];
