...
const MESSAGES: Record<StudioErrorCode, Record<AppLanguage, ErrorMessage>> = {
  [StudioErrorCode.KEY_MISSING]: {
    KO: {
      title: "API 키 필요",
      message: "AI 기능을 사용하려면 API 키를 설정하세요.",
      action: "설정하기",
    },
    EN: {
      title: "API Key Required",
      message: "Set up an API key to use AI features.",
      action: "Set Up",
    },
    JP: {
      title: "APIキーが必要",
      message: "AI機能を使用するにはAPIキーを設定してください。",
      action: "設定する",
    },
    CN: {
      title: "需要API密钥",
      message: "请设置API密钥以使用AI功能。",
      action: "设置",
    },
  },
  [StudioErrorCode.KEY_INVALID]: {
    KO: {
      title: "API 키 오류",
      message: "키가 유효하지 않습니다. 확인 후 다시 입력하세요.",
    },
    EN: {
      title: "Invalid API Key",
      message: "The key is invalid. Please check and re-enter.",
    },
    JP: {
      title: "APIキーエラー",
      message: "キーが無効です。確認して再入力してください。",
    },
  ...
  [StudioErrorCode.KEY_EXPIRED]: {
    KO: {
      title: "API 키 만료",
      message: "키가 만료되었습니다. 새 키를 발급받으세요.",
    },
    EN: {
      title: "API Key Expired",
      message: "Your key has expired. Please generate a new one.",
    },
    JP: {
      title: "APIキー期限切れ",
      message: "キーの期限が切れました。新しいキーを発行してください。",
    },
  ...
  [StudioErrorCode.PROVIDER_ERROR]: {
    KO: {
      title: "AI 서비스 오류",
      message: "제공자 서버에 문제가 발생했습니다. 잠시 후 다시 시도하세요.",
      action: "다시 시도",
    },
    EN: {
      title: "AI Service Error",
      message: "Provider server error. Please try again shortly.",
      action: "Retry",
    },
    JP: {
      title: "AIサービスエラー",
      message: "プロバイダーサーバーにエラーが発生しました。",
      action: "再試行",
    },
    CN: {
      title: "AI服务错误",
      message: "提供商服务器出错，请稍后重试。",
      action: "重试",
    },
  },
  [StudioErrorCode.PROVIDER_FALLBACK]: {
    KO: {
      title: "제공자 전환",
      message: "AI 제공자가 자동으로 전환되었습니다.",
    },
    EN: {
      title: "Provider Switched",
      message: "AI provider was automatically switched.",
    },
    JP: {
      title: "プロバイダー切替",
      message: "AIプロバイダーが自動的に切り替えられました。",
    },
  ...
  [StudioErrorCode.STORAGE_FULL]: {
    KO: {
      title: "저장 공간 부족",
      message: "로컬 저장 공간이 부족합니다. 오래된 세션을 정리하세요.",
      action: "내보내기",
    },
    EN: {
      title: "Storage Full",
      message: "Local storage is full. Export and clear old sessions.",
      action: "Export",
    },
    JP: {
      title: "ストレージ不足",
      message: "ローカルストレージが不足しています。",
      action: "エクスポート",
    },
    CN: {
      title: "存储空间不足",
      message: "本地存储空间不足，请导出并清理旧会话。",
      action: "导出",
    },
  },
  ...
  [StudioErrorCode.CONTENT_TOO_LARGE]: {
    KO: {
      title: "내용 초과",
      message: "요청이 너무 큽니다. 텍스트를 줄여주세요.",
    },
    EN: {
      title: "Content Too Large",
      message: "Request is too large. Please reduce the text.",
    },
    JP: {
      title: "内容超過",
      message: "リクエストが大きすぎます。テキストを減らしてください。",
    },
...
export function getErrorMessage(
  ...
  return (
    MESSAGES[code]?.[language] ?? MESSAGES[StudioErrorCode.UNKNOWN][language]
  );
}
