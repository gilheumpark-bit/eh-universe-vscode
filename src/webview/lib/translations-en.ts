...
const translations = {
  ...
  planning: {
    ...
    corePremisePH:
      "The key rule that makes this world different from reality...",
  ...
  engine: {
    ...
    startPrompt:
      "Design complete. Enter a scene description or event to begin writing.",
  ...
  confirm: {
    ...
    logout: "Logout",
    logoutMsg:
      "Are you sure you want to logout? Unsaved API keys will be cleared.",
  ...
  ui: {
    ...
    apiKeySetUp: "Set Up",
    workflowGuide:
      "World Design → Characters → Direction → Writing — follow the workflow",
    noApiKeyGuide:
      "💡 World/character/direction design and manual editing work without API key",
    saveSetting: "Save",
    ...
    workflowOverview:
      "World Design → Characters → Direction → AI Writing → EPUB Export",
  ...
  writingMode: {
    ...
    directivePlaceholder:
      'Prompt directive (e.g. "hardboiled style", "50% dialogue", "1st person POV")',
    describeFirstScene: "Describe the first scene in the input below",
    modePickerCaption: "Writing mode",
    emptyStateManualHint:
      "To type without AI, use the button below or choose Write at the top of this column.",
    ...
    editDescWithApi:
      "Direct editing available. Select text → run AI rewrite/expand/compress actions.",
    editDescNoApi:
      "Direct editing available. (AI rewrite actions require API key)",
    ...
    preciseInstruction:
      "🎯 Precise instruction (configured constraints auto-applied)",
    advancedGuide:
      "※ Scene goals, narrative constraints, references, and locks are auto-combined into the prompt.",
    apiKeyPlaceholder:
      "🔒 API key required for AI generation. Use Write (✏️) mode instead.",
  ...
  canvas: {
    ...
    customInstruction:
      '💡 Custom instruction (e.g. "extend fight scene", "softer dialogue", "change cliffhanger")',
    send: "Send",
    canvasPlaceholder:
      "3-Pass Canvas — Send custom instructions above, or click pass buttons below in order.",
    ...
    saveManuscript: "Save",
    canvasGuide:
      "※ Click pass → Check result in AI chat → 📋 Pull to canvas for editing → Next pass",
  ...
  itemStudio: {
    ...
    summaryTemplate:
      "${name} is for ${purpose}, used by ${owner}, with ${effect} ability, but costs ${cost}.",
    ...
    warningSkillComplexity:
      "⚠️ Avg ${avg} skills per character — high complexity",
    rarityCommon: "Common",
  ...
  planningExtra: {
    ...
    worldFormulaSentence:
      'This is a {genre} world premised on "{premise}", with a power structure of {power}, revolving around the conflict: "{conflict}".',
    ...
    ratingGuide:
      "Based on international standards: ALL=General, T15=Teen(13+), M18=Mature(18+)",
  },
  resourceExtra: {
  ...
  autoRefiner: {
    ...
    apiKeyMissing:
      "API key not set. Please enter your API key in the Settings tab.",
  },
  tabAssistant: {
    apiKeyMissing:
  ...
  genreReview: {
    ...
    insufficientMs:
      "⚠️ Not enough manuscript text. Write in the Writing tab first.",
  ...
  pipeline: {
    ...
    formattingRule1:
      "Parentheses: Remove ( ) symbols only. Keep inner text and merge into surrounding sentence. No line deletion or addition.",
    formattingRule2:
      "Subheadings: Do not generate subheading lines. Do not embed subheading content into body text.",
    formattingRule3:
      "Dialogue: Every dialogue must start on a new line. Inline dialogue must be split to a new line.",
    formattingRule4: "Em dash: Do not use — (em dash).",
    formattingRule5:
      "Word count: Punctuation, spacing, and line breaks may be adjusted. Deleting words, sentences, paragraphs, or compressing/summarizing content is strictly forbidden.",
    formattingRule6:
      "Ellipsis: Three or more periods (...) must be unified to ellipsis character (…).",
    formattingRule7:
      "Typos: Fix obvious typos, spelling, and spacing in narration only. Dialogue text must not be modified to preserve character voice and tone.",
  },
  shadow: {
    arcState: "Arc State",
    progress: "progress",
  ...
  hfcpLabels: {
    ...
    silent:
      "[HFCP Mode: Silent] Respond with questions only. No direct answers.",
    nrgVariation:
      "[NRG: Variation] Use different structure from previous answer.",
    nrgFrameShift:
      "[NRG: Frame Shift] Approach from a completely different angle.",
    nrgPerspectiveShift:
      "[NRG: Perspective Shift] Use exploratory/critical perspective.",
  ...
  onboarding: {
    ...
    step01Desc:
      "Pick a genre and enter one line. We turn it into a title, key cast, and your first scene draft.",
    ...
    step02Desc:
      "Move between AI draft, canvas flow, and manual editing without leaving the same workspace.",
    ...
    step03Desc:
      "Episode saves, version compare, and manuscript management are already connected in one loop.",
  ...
  settingsEngine: {
    ...
    temperatureDesc:
      "AI generation creativity level (0.0 = precise, 1.0 = creative)",
    mobile: "Mobile",
    web: "Web",
  },
  apiKeyModalExtra: {
