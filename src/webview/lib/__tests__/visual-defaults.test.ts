  ...
  describe("createCardFromAnalysis", () => {
    ...
    it("creates character focus card when characterState provided", () => {
      const cards = createCardFromAnalysis(2, {
        characterState: [
          { name: "Alice", emotion: { primary: "happy" }, pose: "sitting" },
        ],
      });
    ...
    it("creates all 3 cards with full analysis", () => {
      const cards = createCardFromAnalysis(4, {
        characterState: [
          { name: "Bob", emotion: { primary: "angry" }, pose: "running" },
        ],
        backgroundState: {
          location: "Forest",
          lighting: "sunlight",
        ...
        sceneState: {
          summary: "A chase scene",
          turningPoint: "caught",
          tension: "high",
        },
        imagePromptPack: {
          characterFocus: "Bob running",
          backgroundFocus: "dark forest",
          sceneFocus: "chase",
        },
      });
