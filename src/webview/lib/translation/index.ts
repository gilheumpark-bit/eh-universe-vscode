...
export {
  ...
  type SegmentEdit,
} from "./editable-segment";

// ── Segment Operations (부분 재번역, 재채점, 코멘트) ──
export {
  buildPartialRetranslatePrompt,
  buildSegmentScorePrompt,
  parseSegmentScore,
  addComment,
  getEditSummary,
} from "./segment-operations";

// ── Glossary Auto-Extraction ──
export {
  buildGlossaryExtractionPrompt,
  parseGlossaryCandidates,
  extractTermsRuleBased,
...
export {
  initMultiLangProgress,
  updateLangProgress,
  overallProgress,
  allDone,
  getOutputFileName,
  type TargetLanguage,
  type MultiLangBatchConfig,
  type MultiLangProgress,
  type MultiLangResult,
} from "./multi-lang-batch";
