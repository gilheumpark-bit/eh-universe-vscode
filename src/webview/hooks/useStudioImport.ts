...
export function useStudioImport({
  ...
  useEffect(() => {
    ...
    try {
      ...
      const genreGuess = (json.tags as string[] | undefined)?.find(
        (tag: string) =>
          Object.values(Genre)
            .map((g) => g.toLowerCase())
      ...
      if (genreGuess) {
        const matched = Object.values(Genre).find(
          (g) => g.toLowerCase() === genreGuess.toLowerCase(),
        );
      ...
      setAlertToast({
        message:
          language === "KO"
            ? "\\uC138\\uACC4\\uAD00 \\uB370\\uC774\\uD130\\uB97C \\uBD88\\uB7EC\\uC624\\uC9C0 \\uBABB\\uD588\\uC2B5\\uB2C8\\uB2E4. \\uB9C1\\uD06C\\uAC00 \\uC190\\uC0C1\\uB410\\uC744 \\uC218 \\uC788\\uC2B5\\uB2C8\\uB2E4."
            : "Failed to import world data. The link may be corrupted.",
        variant: "error",
      });
      studioRouter.replace(`${pathname}?tab=${activeTab}`, { scroll: false });
    }
  ...
  useEffect(() => {
    ...
    try {
      ...
      setAlertToast({
        message:
          language === "KO"
            ? "\\uAC8C\\uC2DC\\uAE00 \\uB370\\uC774\\uD130\\uB97C \\uBD88\\uB7EC\\uC624\\uC9C0 \\uBABB\\uD588\\uC2B5\\uB2C8\\uB2E4."
            : "Failed to import post data.",
        variant: "error",
      });
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  useEffect(() => {
    ...
    if (
      ...
      !localStorage.getItem("noa_onboarding_done")
    ) {
