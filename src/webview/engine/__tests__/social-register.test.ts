...
describe("formatSocialProfile", () => {
  ...
  it("handles all relation types in KO", () => {
    const types: SocialProfile["relationDistance"][] = [
      "stranger",
      "formal",
      "colleague",
      "friend",
  ...
  it("handles all age registers in EN", () => {
    const ages: SocialProfile["ageRegister"][] = [
      "teen",
      "young_adult",
      "adult",
      "middle",
  ...
  it("handles all explicitness levels", () => {
    const levels: SocialProfile["explicitness"][] = [
      "none",
      "implied",
      "low",
      "medium",
  ...
  it("handles all profanity levels", () => {
    const levels: SocialProfile["profanityLevel"][] = [
      "none",
      "mild",
      "strong",
    ];
