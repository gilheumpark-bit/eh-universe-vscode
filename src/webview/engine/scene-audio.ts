...
export function detectAmbient(mood?: string, timeOfDay?: string): AmbientType {
  ...
  if (timeOfDay && TIME_TO_AMBIENT[timeOfDay])
    return TIME_TO_AMBIENT[timeOfDay];
  return "silence";
}
...
export function createAudioEngine(): AudioEngine | null {
  ...
  return {
    ...
    playSFX(type: SFXType) {
      switch (type) {
        case "footstep":
          playTone(100, 0.1, "square", 0.05);
          break;
        case "door-open":
          playTone(200, 0.3, "triangle", 0.08);
        ...
        case "heartbeat":
          ...
          setTimeout(() => playTone(55, 0.12, "sine", 0.12), 200);
          break;
        case "glass-break":
          playTone(3000, 0.05, "sawtooth", 0.08);
          playTone(5000, 0.03, "square", 0.06);
          break;
        case "sword-clash":
          ...
          break;
        case "gunshot":
          playTone(150, 0.05, "square", 0.2);
          playTone(2000, 0.02, "sawtooth", 0.15);
          break;
        case "explosion":
          playTone(40, 0.5, "sawtooth", 0.2);
        ...
        case "gasp":
          ...
          break;
        case "paper-rustle":
          playTone(6000, 0.08, "sawtooth", 0.02);
          break;
        case "clock-tick":
          playTone(1200, 0.03, "square", 0.04);
          break;
        case "phone-ring":
          playTone(1400, 0.15, "sine", 0.1);
          setTimeout(() => playTone(1700, 0.15, "sine", 0.1), 200);
          break;
        case "splash":
          playTone(200, 0.2, "triangle", 0.1);
          playTone(3000, 0.1, "sawtooth", 0.04);
          break;
        case "thud":
          playTone(50, 0.15, "square", 0.12);
          break;
        case "whisper-wind":
          playTone(300, 0.4, "sine", 0.03);
          break;
      }
    },
