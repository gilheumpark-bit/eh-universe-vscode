...
export default function SplashScreen({
  ...
  const allCards = [
    {
      ...
      title: "UNIVERSE",
      desc: {
        ko: "아카이브, 네트워크, 세계관 문서를 탐색합니다.",
        en: "Browse the archive, network, and worldbuilding docs.",
        ja: "アーカイブ、ネットワーク、世界観文書を探索します。",
        zh: "探索档案库、网络和世界观文档。",
      },
    ...
    },
    {
      ...
      title: "STUDIO",
      desc: {
        ko: "AI와 함께 세계관 기반 소설을 집필합니다.",
        en: "Write stories with AI in this universe.",
        ja: "AIと共に世界観ベースの小説を執筆します。",
        zh: "与AI一起在这个世界观中写作。",
      },
      cta: {
        ko: "스튜디오 열기",
    ...
    },
    {
      ...
      title: "CODE",
      desc: {
        ko: "Monaco 에디터 기반 코드 작업 환경.",
        en: "Monaco-based coding environment with AI.",
        ja: "Monacoエディタベースのコーディング環境。",
        zh: "基于Monaco编辑器的编码环境。",
      },
      cta: {
        ko: "코드 스튜디오",
  ...
  const cards = flags.CODE_STUDIO
    ? allCards
    : allCards.filter((c) => c.id !== "code");

  const colorMap: Record<
    string,
    { border: string; bg: string; text: string; glow: string; shadow: string }
  > = {
    amber: {
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <p
                      className={`font-mono text-[10px] uppercase tracking-[0.2em] ${c.text}`}
                    >
                      {L4(lang, card.kicker)}
                    </p>
                    {card.badge && (
