...
export function TabletLayout({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Compact toolbar */}
      <div
        className="flex items-center gap-1 px-2 border-b border-white/8 bg-[#0a0e17]"
      ...
      <div className="flex flex-1 overflow-hidden relative">
        {sidebarVisible && (
          <div
            className="flex-shrink-0 border-r border-white/8 bg-[#0f1419] overflow-y-auto"
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {terminalVisible && (
            <div
              className="border-t border-white/8 bg-[#0f1419] flex flex-col"
              style={{ maxHeight: "40vh", minHeight: 120 }}
            >
        ...
        {rightPanelVisible && (
          <>
            <div
              className="absolute inset-0 z-[59] bg-black/30"
              onClick={() => setRightPanelVisible(false)}
            />
            <div
              className="absolute top-0 right-0 bottom-0 z-[60] bg-[#0f1419] border-l border-white/8 overflow-y-auto"
              style={{ width: 320 }}
            >
              <div className="flex items-center justify-between px-3 py-1 border-b border-white/8">
