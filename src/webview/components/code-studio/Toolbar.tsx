...
function ToolbarMenu({
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen((v) => !v)}
        className="px-2 py-1 rounded text-xs text-text-secondary hover:bg-bg-secondary/60 hover:text-text-primary transition-colors"
      >
        {label}
      </button>
      {open && (
    ...
    <div className="flex items-center justify-between px-3 py-1.5 bg-bg-primary border-b border-border">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-bold tracking-tight text-text-primary">
          EH <span className="text-accent-amber">Code</span>
        </span>
      </div>
      <div className="flex items-center gap-0.5 text-xs">
        ...
        <button
          ...
          title="Undo (Ctrl+Z)"
          aria-label="실행 취소"
          className="p-1.5 rounded hover:bg-bg-secondary/60 text-text-secondary transition-colors"
        >
          <Undo2 size={14} />
        </button>
        <button
        ...
        {fontSize != null && (
          <button
            onClick={onZoomReset}
            title="Reset zoom"
            aria-label="글꼴 크기 초기화"
            className="px-1.5 text-[10px] text-text-tertiary hover:bg-bg-secondary/60 rounded transition-colors"
          >
            {fontSize}px
          </button>
        )}
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          aria-label="설정 열기"
          className="p-1.5 rounded hover:bg-bg-secondary/60 text-text-secondary"
        >
          <Settings size={14} />
        </button>
      </div>
