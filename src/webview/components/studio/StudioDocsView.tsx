...
const SECTIONS: Record<AppLanguage, DocSection[]> = {
  ...
  JP: [
    ...
    },
    {
      ...
      title: "6. 執筆スタジオ",
      content:
        "5モード: 草稿生成 / 執筆 / 3段階作成 / AUTO 30% / 精密執筆\nインラインリライター\nEngine Reportインライン表示\nNOD監督リアルタイム分析\n誤字検出\n\nNOW AIチャット",
    },
    {
      id: "style",
      title: "7. 文体スタジオ",
      content:
        "入り口: 小説スタジオ `/studio` → 文体タブ (`?tab=style`)。独立した `/tools/style-studio` 製品ページはありません（旧URLはスタジオへリダイレクト）。\n\n4種DNA / 5スライダー / 10スタイルプリセット\n文体実験室\nNOE AIチャット",
    },
    {
      id: "manuscript",
      title: "8. 原稿管理",
      content:
        "チャプター分析: AI自動抽出 (人物/背景/シーン/サウンド/画像プロンプト/音楽プロンプト)\nエクスポート6種: EPUB / DOCX / TXT / JSON / Backup / インポート\nセーブスロット: 設定の完全保存/復元",
    },
    {
      id: "engine",
      title: "9. エンジンシステム",
    ...
    },
    {
      ...
      title: "12. 共通機能",
      content:
        "自動保存 (localStorage + IndexedDBバックアップ)\n最終保存時刻表示\nGoogle Drive同期\n4言語 (KO / EN / JP / CN)\nガイド/フリーモード切替\nWCAG AAアクセシビリティ\nキーボードショートカット",
    },
  ],
  CN: [
    {
    ...
    },
    {
      ...
      title: "6. 写作工作室",
      content:
        "5种模式: 草稿生成 / 写作 / 3步创作 / AUTO 30% / 精密写作\n行内重写器\nEngine Report行内显示\nNOD导演实时分析\n错别字检测\n\nNOW AI聊天",
    },
    {
      id: "style",
      title: "7. 文体工作室",
      content:
        "入口：小说工作室 `/studio` → 文体标签页 (`?tab=style`)。无独立 `/tools/style-studio` 产品页（旧链接会重定向到工作室）。\n\n4种DNA / 5个滑块 / 10种风格预设\n文体实验室\nNOE AI聊天",
    },
    {
      id: "manuscript",
      title: "8. 稿件管理",
      content:
        "章节分析: AI自动提取 (人物/背景/场景/声音/图像提示/音乐提示)\n导出6种: EPUB / DOCX / TXT / JSON / Backup / 导入\n存档槽: 完整配置保存/恢复",
    },
    {
      id: "engine",
      title: "9. 引擎系统",
