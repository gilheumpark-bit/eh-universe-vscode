...
const TAB_PRESETS: Record<string, { ko: string; en: string }[]> = {
  world: [
    {
      ko: "현재 세계관 설정에 모순이 있는지 검토해줘",
      en: "Check my worldbuilding for contradictions",
    },
    {
      ko: "이 세계의 경제 시스템을 설계해줘",
      en: "Design an economic system for this world",
    },
    {
      ko: "마법/기술 체계의 비용-제한을 제안해줘",
      en: "Suggest costs and limits for the magic/tech system",
    },
    {
      ko: "이 배경에서 가능한 종교/신앙 체계는?",
      en: "What religion/belief systems fit this setting?",
    },
    {
      ko: "세계관 확장 가능한 미개척 영역을 제안해줘",
      en: "Suggest unexplored areas for worldbuilding expansion",
    },
    {
      ko: "이 설정에서 발생할 수 있는 사회적 갈등은?",
      en: "What social conflicts could arise from this setting?",
    },
    {
      ko: "독자가 이해하기 어려운 설정을 짚어줘",
      en: "Flag settings that might confuse readers",
    },
    {
      ko: "역사적 사건 타임라인을 정리해줘",
      en: "Organize a historical event timeline",
    },
    {
      ko: "이 세계의 일상생활은 어떤 모습일까?",
      en: "What does daily life look like in this world?",
    },
    {
      ko: "다른 SF/판타지 작품과 차별화할 점을 제안해줘",
      en: "How can I differentiate from other SF/fantasy works?",
    },
  ],
  critique: [
    {
      ko: "현재 세력 균형을 분석해줘",
      en: "Analyze the current power balance",
    },
    {
      ko: "가장 불안정한 세력 관계는?",
      en: "Which faction relationship is most unstable?",
    },
    {
      ko: "A 세력이 B를 공격하면 어떻게 될까?",
      en: "What happens if Faction A attacks Faction B?",
    },
    {
      ko: "문명 간 경제 의존도를 평가해줘",
      en: "Evaluate economic interdependence between civilizations",
    },
    {
      ko: "현재 균형이 깨질 트리거 3개를 찾아줘",
      en: "Find 3 triggers that could break the current balance",
    },
    {
      ko: "시대 전환의 인과 체인을 분석해줘",
      en: "Analyze the cause-effect chain of the era transition",
    },
    {
      ko: "약소 세력이 강대 세력을 이길 시나리오는?",
      en: "Scenario where a weak faction defeats a strong one?",
    },
    {
      ko: "동맹이 깨질 수 있는 조건은?",
      en: "Under what conditions could the alliance break?",
    },
    {
      ko: "장르 규칙과 시뮬레이터 데이터가 일치하는지 확인",
      en: "Check if genre rules match simulator data",
    },
    {
      ko: "100년 후 이 세계는 어떤 모습일까?",
      en: "What does this world look like 100 years later?",
    },
  ],
  characters: [
    {
      ko: "이 캐릭터의 3층 성격을 분석해줘",
      en: "Analyze this character's 3-layer personality",
    },
    {
      ko: "캐릭터별 대사 DNA를 정의해줘",
      en: "Define each character's dialogue DNA",
    },
    {
      ko: "두 캐릭터 사이의 관계 동역학을 분석해줘",
      en: "Analyze the relationship dynamics between two characters",
    },
    {
      ko: "이 캐릭터의 성장 아크를 설계해줘",
      en: "Design this character's growth arc",
    },
    {
      ko: "캐릭터의 want vs need를 분리해줘",
      en: "Separate this character's want vs need",
    },
    {
      ko: "이 캐릭터만의 말버릇/습관을 3개 만들어줘",
      en: "Create 3 unique speech habits for this character",
    },
    {
      ko: "위기 상황에서 이 캐릭터는 어떻게 반응할까?",
      en: "How would this character react in a crisis?",
    },
    {
      ko: "캐릭터 간 갈등 축을 정리해줘",
      en: "Map out the conflict axes between characters",
    },
    {
      ko: "빌런/적대자의 동기를 더 입체적으로 만들어줘",
      en: "Make the villain/antagonist's motivation more dimensional",
    },
    {
      ko: "새 조연 캐릭터를 제안해줘",
      en: "Suggest a new supporting character",
    },
  ],
  rulebook: [
    {
      ko: "현재 장면의 텐션 스코어를 평가해줘",
      en: "Evaluate the tension score of the current scene",
    },
    {
      ko: "오프닝 후크를 강화할 방법은?",
      en: "How can I strengthen the opening hook?",
    },
    {
      ko: "고구마-사이다 밸런스를 분석해줘",
      en: "Analyze the frustration-relief balance",
    },
    {
      ko: "클리프행어 아이디어를 3개 제안해줘",
      en: "Suggest 3 cliffhanger ideas",
    },
    {
      ko: "이 장면에 넣을 도파민 장치를 추천해줘",
      en: "Recommend dopamine devices for this scene",
    },
    { ko: "씬 비트를 카드로 정리해줘", en: "Organize scene beats into cards" },
    {
      ko: "독자가 지루해질 구간을 찾아줘",
      en: "Find sections where readers might get bored",
    },
    {
      ko: "감정 곡선이 단조로운 부분을 수정해줘",
      en: "Fix sections with flat emotional curves",
    },
    {
      ko: "반전을 위한 복선을 어디에 깔아야 할까?",
      en: "Where should I plant foreshadowing for a twist?",
    },
    {
      ko: "이 에피소드의 긴장 곡선을 설계해줘",
      en: "Design the tension curve for this episode",
    },
  ],
  style: [
    {
      ko: "내 문장의 리듬을 분석해줘",
      en: "Analyze the rhythm of my sentences",
    },
    {
      ko: "AI 문체 증상이 있는지 체크해줘",
      en: "Check for AI-style writing symptoms",
    },
    {
      ko: "이 단락을 더 감각적으로 바꿔줘",
      en: "Rewrite this paragraph with more sensory detail",
    },
    {
      ko: "반복되는 단어/표현을 찾아줘",
      en: "Find repeated words or expressions",
    },
    {
      ko: "대화문의 캐릭터별 차별화를 평가해줘",
      en: "Evaluate dialogue differentiation per character",
    },
    {
      ko: "묘사 밀도가 높은/낮은 구간을 찾아줘",
      en: "Find over-described and under-described sections",
    },
    {
      ko: "서술 시점이 흔들리는 곳을 잡아줘",
      en: "Catch POV shifts or inconsistencies",
    },
    {
      ko: "문장을 더 간결하게 압축하는 방법은?",
      en: "How can I compress sentences to be more concise?",
    },
    {
      ko: "하드보일드 문체로 변환 연습을 해보자",
      en: "Let's practice converting to hardboiled style",
    },
    {
      ko: "5가지 지표로 내 문체를 종합 평가해줘",
      en: "Give me a comprehensive 5-metric style evaluation",
    },
  ],
  writing: [
    {
      ko: "다음 장면 전개를 세 가지 방향으로 제안해줘",
      en: "Suggest three directions to continue the next scene",
    },
    {
      ko: "지금 대사의 말투를 캐릭터에 맞게 다듬어줘",
      en: "Polish the dialogue to match each character's voice",
    },
    {
      ko: "이 구간의 템포가 느려지는 이유를 짚어줘",
      en: "Explain why this section feels slow in pacing",
    },
    {
      ko: "클리프행어 후킹을 한 줄로 제안해줘",
      en: "Propose a one-line cliffhanger hook",
    },
    {
      ko: "독자 시점에서 지금 감정선이 어떻게 느껴질지 말해줘",
      en: "How would readers feel about the emotional arc here?",
    },
    {
      ko: "복선을 자연스럽게 심을 위치를 추천해줘",
      en: "Where should I plant foreshadowing more naturally?",
    },
    {
      ko: "장면 목표(정보·감정·전환)를 한 줄로 정리해줘",
      en: "Summarize this scene's goal in one line (info/emotion/pivot)",
    },
    {
      ko: "서술 시점이 흔들리는 문장이 있으면 짚어줘",
      en: "Flag any sentences where POV or narration wobbles",
    },
    {
      ko: "이 대목을 더 몰입감 있게 바꾸는 한 문단 예시를 줘",
      en: "Give a sample paragraph that increases immersion here",
    },
    {
      ko: "원고와 설정 사이에 어긋나는 점이 있으면 알려줘",
      en: "Flag any mismatch between the draft and established setting",
    },
  ],
};
...
function buildContextSummary(config: StoryConfig | null, tab: AppTab): string {
  ...
  switch (tab as string) {
    case "world":
      if (config.synopsis)
        parts.push(`시놉시스: ${config.synopsis.slice(0, 500)}`);
      if (config.setting) parts.push(`세부 배경: ${config.setting}`);
      // 세계관 3-tier
      if (config.corePremise) parts.push(`핵심 전제: ${config.corePremise}`);
      if (config.powerStructure)
        parts.push(`권력 구조: ${config.powerStructure}`);
      if (config.currentConflict)
        parts.push(`현재 갈등: ${config.currentConflict}`);
      if (config.worldHistory) parts.push(`역사: ${config.worldHistory}`);
      if (config.magicTechSystem)
        parts.push(`마법/기술 체계: ${config.magicTechSystem}`);
      if (config.worldSimData?.civs?.length) {
        parts.push(
          `등록된 문명: ${config.worldSimData.civs.map((c) => `${c.name}(${c.era}, 특성: ${c.traits.join("·")})`).join(" / ")}`,
        );
      }
      if (config.worldSimData?.relations?.length) {
        parts.push(
          `세력 관계: ${config.worldSimData.relations.map((r) => `${r.fromName}→${r.toName}: ${r.type}`).join(", ")}`,
        );
      }
      if (config.characters?.length) {
        parts.push(
          `캐릭터: ${config.characters.map((c) => `${c.name}(${c.role})`).join(", ")}`,
        );
      }
      break;
    ...
    case "critique":
      if (config.synopsis)
        parts.push(`시놉시스: ${config.synopsis.slice(0, 300)}`);
      if (config.worldSimData?.civs?.length) {
        config.worldSimData.civs.forEach((c) => {
          parts.push(
            `[문명] ${c.name} — 시대: ${c.era}, 특성: ${c.traits.join("·")}`,
          );
        });
      }
      if (config.worldSimData?.relations?.length) {
      ...
      if (config.worldSimData?.genreSelections?.length) {
        parts.push(
          `장르 블렌드: ${config.worldSimData.genreSelections.map((g) => `${g.genre}(Lv${g.level})`).join(", ")}`,
        );
      }
    ...
    case "characters":
      if (config.synopsis)
        parts.push(`시놉시스: ${config.synopsis.slice(0, 200)}`);
      if (config.characters?.length) {
    ...
    case "rulebook":
      if (config.synopsis)
        parts.push(`시놉시스: ${config.synopsis.slice(0, 200)}`);
      if (config.episode)
        parts.push(`현재 에피소드: ${config.episode}/${config.totalEpisodes}`);
      if (config.sceneDirection) {
        const sd = config.sceneDirection;
        if (sd.hooks?.length)
          parts.push(
            `후크: ${sd.hooks.map((h) => `${h.position}-${h.hookType}: ${h.desc}`).join(" / ")}`,
          );
        if (sd.goguma?.length)
          parts.push(
            `고구마/사이다: ${sd.goguma.map((g) => `${g.type}(${g.intensity}): ${g.desc}`).join(" / ")}`,
          );
        if (sd.emotionTargets?.length)
          parts.push(
            `감정 타겟: ${sd.emotionTargets.map((e) => `${e.emotion}(${e.intensity})`).join(", ")}`,
          );
        if (sd.cliffhanger)
          parts.push(
            `클리프행어: ${sd.cliffhanger.cliffType} — ${sd.cliffhanger.desc}`,
          );
        if (sd.dopamineDevices?.length)
          parts.push(
            `도파민 장치: ${sd.dopamineDevices.map((d) => `${d.scale}-${d.device}: ${d.desc}`).join(" / ")}`,
          );
      }
      if (config.characters?.length) {
        parts.push(
          `캐릭터: ${config.characters.map((c) => c.name).join(", ")}`,
        );
      }
      break;
    ...
    case "writing":
      if (config.synopsis)
        parts.push(`시놉시스: ${config.synopsis.slice(0, 400)}`);
      if (config.episode)
        parts.push(`에피소드: ${config.episode}/${config.totalEpisodes}`);
      if (config.characters?.length) {
        parts.push(
          `캐릭터: ${config.characters.map((c) => `${c.name}(${c.role})`).join(", ")}`,
        );
    ...
    case "style":
      if (config.synopsis)
        parts.push(`시놉시스: ${config.synopsis.slice(0, 150)}`);
      if (config.styleProfile) {
        const sp = config.styleProfile;
        const sliderKeys = Object.keys(sp.sliders || {});
        if (sliderKeys.length) {
          parts.push(
            `스타일 슬라이더: ${sliderKeys.map((k) => `${k}=${sp.sliders[k]}`).join(", ")}`,
          );
        }
        if (sp.selectedDNA?.length)
          parts.push(`선택된 DNA: ${sp.selectedDNA.join(", ")}`);
        if (sp.checkedSF?.length)
          parts.push(`SF 기법 체크: ${sp.checkedSF.length}개`);
        if (sp.checkedWeb?.length)
          parts.push(`웹소설 기법 체크: ${sp.checkedWeb.length}개`);
      }
      if (config.primaryEmotion)
        parts.push(`핵심 감정: ${config.primaryEmotion}`);
      break;
...
const TabAssistant: React.FC<TabAssistantProps> = ({
  tab,
  language,
  config,
  hostedProviders = {},
  ...
  const hasAiKey = Boolean(
    getApiKey(getActiveProvider()) || hostedProviders[getActiveProvider()],
  );
  ...
  useEffect(() => {
    ...
    localStorage.setItem(
      `${STORAGE_PREFIX}${tab}`,
      JSON.stringify(messages.slice(-HISTORY_LIMITS.STORAGE)),
    );
  }, [messages, tab]);
  ...
  const handleSend = useCallback(async () => {
    ...
    if (!hasAiKey) {
      const errMsg: TabMessage = {
        id: `te-${Date.now()}`,
        role: "assistant",
        content: tl("tabAssistant.apiKeyMissing"),
      };
      setMessages((prev) => [...prev, errMsg]);
      return;
    }

    const userMsg: TabMessage = {
      id: `tu-${Date.now()}`,
      role: "user",
      content: text,
    };
    ...
    const recentMsgs: ChatMsg[] = messages
      .slice(-HISTORY_LIMITS.CHAT_API)
      .map((m) => ({
        role: m.role as "user" | "assistant",
        content: m.content,
      }));
    const model = getActiveModel();
    const { messages: trimmedHistory } = truncateMessages(
      systemPrompt,
      recentMsgs,
      model,
    );
    ...
    <div className="border border-border rounded-2xl bg-bg-secondary/50 overflow-hidden flex flex-col">
      ...
      >
        <span className="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-xs font-black uppercase tracking-widest text-accent-purple font-mono min-w-0 text-left">
          ...
          {backendLabel ? (
            <span
              className="text-[10px] font-mono font-bold text-text-tertiary normal-case tracking-normal truncate max-w-[min(100%,14rem)]"
              title={backendLabel}
            >
              · {backendLabel}
            </span>
          ...
          <div className="max-h-60 sm:max-h-80 overflow-y-auto px-4 py-2 space-y-3 custom-scrollbar">
            ...
            {messages.map((msg) => (
              ...
              >
                ...
                <div
                  className={`max-w-[90%] sm:max-w-[80%] px-3 py-2.5 rounded-xl text-sm leading-relaxed ${
                    msg.role === "user"
                      ? "bg-bg-tertiary/80 text-text-secondary"
                      : msg.content?.includes("NOA 보안 차단")
          ...
          <div className="p-3 border-t border-border">
            <div className="flex items-end gap-2">
              {messages.length > 0 && (
                <button
                  onClick={clearChat}
                  aria-label={tl("tabAssistant.clearChat")}
                  className="p-2 rounded-lg text-text-tertiary hover:text-accent-red hover:bg-bg-tertiary/50 transition-colors shrink-0"
                  title={tl("tabAssistant.clearChat")}
                >
              ...
              {isStreaming ? (
                <button
                  ...
                  aria-label="중단"
                  className="p-2 rounded-xl bg-accent-red text-white shrink-0 hover:opacity-80 transition-opacity"
                >
                ...
                <button
                  ...
                  disabled={!input.trim()}
                  aria-label="전송"
                  className={`p-2 rounded-xl shrink-0 transition-colors ${input.trim() ? "bg-accent-purple text-white" : "bg-bg-tertiary text-text-tertiary"}`}
                >
