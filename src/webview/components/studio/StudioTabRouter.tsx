...
const NetworkFeedWidget = dynamic(
  () => import("@/components/studio/NetworkFeedWidget"),
  { ssr: false, loading: DynSkeleton },
);
const StudioDocsView = dynamic(
  () => import("@/components/studio/StudioDocsView"),
  { ssr: false, loading: DynSkeleton },
);
const VisualTab = dynamic(() => import("@/components/studio/tabs/VisualTab"), {
  ssr: false,
  loading: DynSkeleton,
});
const HistoryTab = dynamic(
  () => import("@/components/studio/tabs/HistoryTab"),
  { ssr: false, loading: DynSkeleton },
);
const RulebookTab = dynamic(
  () => import("@/components/studio/tabs/RulebookTab"),
  { ssr: false, loading: DynSkeleton },
);
const WritingTabInline = dynamic(
  () => import("@/components/studio/tabs/WritingTabInline"),
...
interface StudioTabRouterProps {
  ...
  setConfig: (
    config: StoryConfig | ((prev: StoryConfig) => StoryConfig),
  ) => void;
  ...
  setAdvancedSettings: React.Dispatch<
    React.SetStateAction<AdvancedWritingSettings>
  >;
      ...
      {activeTab === "writing" && currentSession && config && (
        <SectionErrorBoundary sectionName="Writing" fallbackHeight={400}>
          <WritingTabInline
            ...
            setConfig={setConfig}
            writingMode={
              writingMode as "ai" | "edit" | "canvas" | "refine" | "advanced"
            }
            ...
            setPromptDirective={setPromptDirective}
            ...
            setAdvancedOutputMode={(m: string) =>
              setAdvancedSettings({
                ...advancedSettings,
                outputMode: m as typeof advancedSettings.outputMode,
              })
            }
