          ...
          return (
            <React.Fragment key={stage.stage}>
              ...
              <div
                ...
                title={`${label ? (isKO ? label.ko : label.en) : stage.stage}: ${stage.score ?? "-"}/100`}
              >
        ...
        <div className="mt-2 pt-2 border-t border-white/5">
          {stages
            ...
            .map((s) => (
              <div
                key={s.stage}
                className="font-mono text-[9px] text-amber-400/70 leading-snug"
              >
                {STAGE_LABELS[s.stage]
                  ? isKO
                    ? STAGE_LABELS[s.stage].ko
                    : STAGE_LABELS[s.stage].en
                  : s.stage}
