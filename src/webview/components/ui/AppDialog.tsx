  ...
  return (
    ...
    >
      ...
      >
        <h2
          id="app-dialog-title"
          className="text-sm font-black uppercase tracking-widest theme-text-primary"
        >
          {title}
        </h2>
        <p className="mt-3 whitespace-pre-wrap text-sm leading-relaxed theme-text-secondary">
          {message}
        </p>
